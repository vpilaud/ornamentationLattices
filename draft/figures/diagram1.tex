...
\caption{These diagrams respectively commute by Lemma~\ref{lem:Sour2Orn1}, Lemma~\ref{lem:Orn2Sour4} and Lemma~\ref{lem:AReori2ASour2AOrn}. Let us remark that when we restrict ourself to the acyclic case, the two top diagrams does not commute. }
\end{figure}