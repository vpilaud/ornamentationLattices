...
(note that they are usually called \emph{orientations of hypergraphs}, we have preferred the term \emph{sourcings of hypergraphs} to avoid confusion with the reorientations of graphs).
...
In this section, we characterize the subhypergraphs~$\II$ of the path interval~$\PP(T)$ of an increasing tree~$T$ whose acyclic sourcing poset~$\ASour(\II)$ is a lattice, extending results of N. Bergeron and V. Pilaud for interval hypergraphs.
