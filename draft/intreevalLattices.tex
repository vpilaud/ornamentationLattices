...
%The ornamentation~$O = \orn{R}$ of~$T$ with~$O(d) = \set{w}{a \le_T w \le_T d}$, $O(e) = \set{w}{b \le_T w \le_T e}$,
...
%$a \le_T w <_T d$
(because $w \in O(d)$) and similarly~$(w,e) \in \rev(R')$ for all~$w \in [b,e]_T$. %$b \le_T w <_T e$.
Therefore,~$(a,e) \notin \rev(R')$ (because~${a \notin O(e)}$ while~$(w,e) \in \rev(R')$ for all~$w \in [a,e]_T$ %$a <_T w <_T e$)
and similarly~$(b,d) \notin \rev(R')$.
