...
\begin{figure}
	...
	\caption{The acyclic reorientation posets~$\AReori(\Ygraph)$ and~$\AReori(\Agraph)$.}
	\label{fig:acyclicReorientationsAY}
\end{figure}

\begin{figure}
	\centerline{\includegraphics[scale=.68]{acyclicReorientationsD}}
	\caption{The acyclic reorientation poset~$\AReori(\Dgraph)$.}
...
\begin{figure}
	...
	\caption{The MacNeille completion of the acyclic reorientation poset~$\AReori(\Dgraph)$ of \cref{fig:acyclicReorientationsD}.}
	\label{fig:MacNeilleAcyclicReorientationsD}
\end{figure}
%
\begin{figure}
	\centerline{\includegraphics[scale=.68]{MacNeilleAcyclicOrnamentationsD}}
	\caption{The MacNeille completion of the acyclic ornamentation poset~$\AOrn(\Dgraph)$ of \cref{fig:ornamentationsD}.}
...
\begin{proposition}
For an intreeval hypergraph~$\II$ of an increasing tree~$T$ and~$O_1, \dots, O_q$ some acyclic sourcings of~$\II$, we have
\[
...
\]
\vincent{todo}
