...
\begin{figure}
	...
	\caption{The permutations and sourcings of \cref{exm:pathIntersectionClosed} (left) and of \cref{exm:pathStarSparse} (right), illustrating the proofs of \cref{lem:pathIntersectionClosed,lem:pathStarSparse}. The black arrows indicate relations in weak order.}
