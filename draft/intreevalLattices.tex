...
\begin{figure}
	...
	\caption{The MacNeille completion of the acyclic reorientation poset~$\AReori(\Dgraph)$ of \cref{fig:acyclicReorientationsD}. (Gray = added element).}
	\label{fig:MacNeilleAcyclicReorientationsD}
\end{figure}
%
\begin{figure}
	\centerline{\includegraphics[scale=.68]{MacNeilleAcyclicOrnamentationsD}}
	\caption{The MacNeille completion of the acyclic ornamentation poset~$\AOrn(\Dgraph)$ of \cref{fig:ornamentationsD}. (Gray = added element).}
