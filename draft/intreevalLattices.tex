...
In particular, the acyclic reorientation lattice~$\AReori(\tc(T))$ is a lattice.
\end{proposition}
...
\begin{remark}
Note that it is also straightforward to check that an unstarred tree~$T$ satisfies the condition of~\cref{prop:AReoriLatJoinMeet}.
