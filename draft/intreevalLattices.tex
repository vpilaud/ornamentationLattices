...
\subsection{Semidistributivity and canonical join representations}
...
\subsection{Maximal reorientation and coclosedness}

We first revisit \cref{rem:Reori2OrnIntervals1,rem:Reori2OrnIntervals2} for directed trees.
...
We finally revisit \cref{rem:notTransitivelyCoclosed} for directed trees.
...
We first define the family of unstarred trees by the following equivalent conditions.
