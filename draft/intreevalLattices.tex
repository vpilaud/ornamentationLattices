...
For instance, for the fiber of the ornamentation $O = \!\!\raisebox{-.25cm}{\includegraphics[scale=.8]{ornamentationI7}}$ contains
\[
\raisebox{-.23cm}{\includegraphics[scale=.8]{reorientationI9}}\!\! \le \reori{O} = \!\!\!\!\raisebox{-.23cm}{\includegraphics[scale=.8]{reorientationI10}}\!\! \le \!\!\raisebox{-.23cm}{\includegraphics[scale=.8]{reorientationI11}}
\]
\end{remark}
...
Let~$w \in V$ be such that $u \notin O(w)$ but~$u',v' \in O$.
Then, for any~$v'$ between~$u'$ and~$v$, we have~$v' \in O(w)$, hence~$(u,v') \not \in \maxreori{O}$.
We thus obtained that~$(u,v'), (v',v) \in \maxreori{O}$ implies~$(u,v) \in \maxreori{O}$, that is, $\maxreori{O}$ is transitively closed.
